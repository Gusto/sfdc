...
const CASE_STATUS_READY_FOR_DATA_CAPTURE = "Ready for Data Capture";

export default class TaxResNoticeIndexDetailsNew extends LightningElement {
	@api recordId;
