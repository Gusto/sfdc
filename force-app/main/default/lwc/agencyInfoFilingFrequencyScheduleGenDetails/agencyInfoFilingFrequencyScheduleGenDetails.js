...
export default class AgencyInfo_FilingFrequencySchedule_GenDetails extends LightningElement {
    ...
    getPicklistVals_mainFilingFormat({ data, error }) { // # getPicklistVals_filingFrequencySchduleType 
    ...
    child;
    @wire(getChildFilingFrequencyScheduleRecType, {idAgencyInfoId: '$recordId', strRecType: 'General Details', intCounter: '$counter'})
      ...
      handleSubmitButton(event){
            ...
            * they are identifying the record in the component from one another*/
            ...
            if(this.updateFormNameObjList.length > 0){
                upsertFilingFrequencyRecord({list_FileFreqSch: this.updateFormNameObjList, strRecType: 'General Details', strObjName: 'Filing_Frequency_Schedule__c'})
                .then(result => {
                    this.createdFormId = result;
                    this.error = undefined;

                    const evt = new ShowToastEvent({
                        title: 'Filing Frequency created', //# update Filinf Frequncy
