...
export default class AgencyInfo_FormNameAndNum_GenDetails extends LightningElement {
    ...
    childData;
    @wire(getChildFormNameRecType, {idAgencyInfoId: '$recordId', strRecType: 'General Details', intCounter: '$counter'})
        ...
        console.log('inside handleSubmitButton...');
            ...
            * they are identifying the record in the component from one another*/
                ...
                .then(result => {
                    refreshApex(this.childData);
	                    ...
	                    const evt = new ShowToastEvent({
	                        title: 'Form Name % Number-General Details',
            ...
            if(this.updateFormNameObjList.length > 0){
                upsertFormNameRecord({list_FormNames: this.updateFormNameObjList, strRecType: 'General Details', strObjName: 'Form_Name_Number__c'})
                .then(result => {
