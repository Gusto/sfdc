({
    ...
    handleSave: function (component, event, helper) {
        ...
        action.setParams({
            idCase: component.get("v.idWorkingRecord"),
    ...
    goToHippo: function(component, event, helper) {
        ...
        window.open('https://hippo.gusto.com/companies/' + caseRecord.Account_Company_Id__c + '/employees/' + caseRecord.Contact_Employee_Id__c, '_blank');
    },
